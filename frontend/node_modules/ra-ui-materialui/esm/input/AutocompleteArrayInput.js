...
var AutocompleteArrayInput = function (_a) {
    ...
    var inputEl = useRef();
    var anchorEl = useRef();
    var _j = useInput(__assign({ format: format, id: idOverride, input: inputOverride, isRequired: isRequiredOverride, meta: metaOverride, onBlur: onBlur,
        onChange: onChange,
        onFocus: onFocus,
        parse: parse,
        resource: resource,
    ...
    return (React.createElement(Downshift, __assign({ inputValue: filterValue, onChange: handleChange, selectedItem: selectedItems, itemToString: function (item) { return getChoiceValue(item); } }, rest), function (_a) {
        ...
        return (React.createElement("div", { className: classes.container },
            React.createElement(TextField, __assign({ id: id, fullWidth: true, InputProps: {
                    ...
                    onFocus: onFocus,
                }, error: !!(touched && error), label: React.createElement(FieldTitle, __assign({ label: label }, labelProps, { source: source, resource: resource, isRequired: isRequired })), InputLabelProps: getLabelProps({
                    htmlFor: id,
