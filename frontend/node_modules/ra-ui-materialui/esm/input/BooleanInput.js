...
var BooleanInput = function (_a) {
    ...
    return (React.createElement(FormGroup, __assign({}, sanitizeRestProps(rest)),
        React.createElement(FormControlLabel, { control: React.createElement(Switch, __assign({ id: id, color: "primary", checked: !!value, onChange: handleChange }, inputProps, options)), label: React.createElement(FieldTitle, { label: label, source: source, resource: resource, isRequired: isRequired }) }),
...
BooleanInput.propTypes = __assign({}, InputPropTypes, { options: PropTypes.shape(Switch.propTypes) });
