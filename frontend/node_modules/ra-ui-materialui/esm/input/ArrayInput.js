 ...
 */
export var ArrayInput = function (_a) {
    ...
    var fieldProps = useFieldArray(source, __assign({ initialValue: defaultValue, validate: validate }, rest));
    return (React.createElement(FormControl, __assign({ fullWidth: true, margin: "normal", className: className }, sanitizeRestProps(rest)),
        ...
        cloneElement(Children.only(children), __assign({}, fieldProps, { record: record,
            resource: resource,
            source: source,
            variant: variant,
            margin: margin }))));
