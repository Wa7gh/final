...
var Menu = function (_a) {
    ...
    useSelector(function (state) { return state.router.location.pathname; }); // used to force redraw on navigation
    return (React.createElement("div", __assign({ className: classnames(classes.main, className) }, rest),
        hasDashboard && (React.createElement(DashboardMenuItem, { onClick: onMenuClick, sidebarIsOpen: open })),
        resources
