...
var NavLinkRef = React.forwardRef(function (props, ref) { return (React.createElement(NavLink, __assign({ innerRef: ref }, props))); });
...
var MenuItemLink = forwardRef(function (_a, ref) {
    ...
    var renderMenuItem = function () {
        return (React.createElement(MenuItem, __assign({ className: classnames(classes.root, className), activeClassName: classes.active, component: NavLinkRef, ref: ref }, props, { onClick: handleMenuTap }),
