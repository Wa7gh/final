...
var sanitizeRestProps = function (_a) {
    var basePath = _a.basePath, className = _a.className, classes = _a.classes, saving = _a.saving, label = _a.label, invalid = _a.invalid, variant = _a.variant, handleSubmit = _a.handleSubmit, handleSubmitWithRedirect = _a.handleSubmitWithRedirect, submitOnEnter = _a.submitOnEnter, record = _a.record, redirect = _a.redirect, resource = _a.resource, locale = _a.locale, undoable = _a.undoable, rest = __rest(_a, ["basePath", "className", "classes", "saving", "label", "invalid", "variant", "handleSubmit", "handleSubmitWithRedirect", "submitOnEnter", "record", "redirect", "resource", "locale", "undoable"]);
    return rest;
};
var SaveButton = function (_a) {
    ...
    return (React.createElement(Button, __assign({ className: classnames(classes.button, className), variant: variant, type: type, onMouseDown: handleMouseDown, onClick: handleClick, color: saving ? 'default' : 'primary', "aria-label": displayedLabel }, sanitizeRestProps(rest)),
        saving && saving.redirect === redirect ? (React.createElement(CircularProgress, { size: 18, thickness: 2, className: classes.leftIcon })) : (cloneElement(icon, {
