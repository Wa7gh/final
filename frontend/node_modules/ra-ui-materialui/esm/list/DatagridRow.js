...
var DatagridRow = function (_a) {
    ...
    var handleClick = useCallback(function (event) { return __awaiter(_this, void 0, void 0, function () {
        var effect, _a;
    ...
    return (React.createElement(Fragment, null,
        React.createElement(TableRow, __assign({ className: className, key: id, style: style, hover: hover, onClick: handleClick }, rest),
            ...
            hasBulkActions && (React.createElement(TableCell, { padding: "checkbox" },
                React.createElement(Checkbox, { color: "primary", className: "select-item " + classes.checkbox, checked: selected, onClick: handleToggleSelection }))),
