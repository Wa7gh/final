...
var SimpleFormIterator = /** @class */ (function (_super) {
    ...
    SimpleFormIterator.prototype.render = function () {
        var _this = this;
        var _a = this.props, basePath = _a.basePath, _b = _a.classes, classes = _b === void 0 ? {} : _b, children = _a.children, fields = _a.fields, _c = _a.meta, error = _c.error, submitFailed = _c.submitFailed, record = _a.record, resource = _a.resource, source = _a.source, translate = _a.translate, disableAdd = _a.disableAdd, disableRemove = _a.disableRemove, variant = _a.variant, margin = _a.margin;
        var records = get(record, source);
        return fields ? (React.createElement("ul", { className: classes.root },
            submitFailed && typeof error !== 'object' && error && (React.createElement(FormHelperText, { error: true }, error)),
