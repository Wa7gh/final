...
function PaginationActions(_a) {
    var classesOverride = _a.classes, page = _a.page, rowsPerPage = _a.rowsPerPage, count = _a.count, onChangePage = _a.onChangePage;
    ...
    var renderPageNums = function () {
        return range().map(function (pageNum, index) {
            return pageNum === '.' ? (react_1.default.createElement("span", { key: "hyphen_" + index, className: classes.hellip }, "\u2026")) : (react_1.default.createElement(Button_1.default, { className: "page-number", color: pageNum === page + 1 ? 'default' : 'primary', key: pageNum, "data-page": pageNum - 1, onClick: gotoPage, size: "small" }, pageNum));
        });
    };
    ...
    return (react_1.default.createElement("div", { className: classes.actions },
        page > 0 && (react_1.default.createElement(Button_1.default, { color: "primary", key: "prev", onClick: prevPage, className: "previous-page", size: "small" },
            react_1.default.createElement(ChevronLeft_1.default, null),
            translate('ra.navigation.prev'))),
        renderPageNums(),
        page !== nbPages - 1 && (react_1.default.createElement(Button_1.default, { color: "primary", key: "next", onClick: nextPage, className: "next-page", size: "small" },
