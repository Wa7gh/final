...
var FormTab = /** @class */ (function (_super) {
    ...
    function FormTab() {
        ...
        _this.renderContent = function (_a) {
            var contentClassName = _a.contentClassName, children = _a.children, hidden = _a.hidden, basePath = _a.basePath, record = _a.record, resource = _a.resource, variant = _a.variant, margin = _a.margin;
            return (react_1.default.createElement("span", { style: hidden ? hiddenStyle : null, className: contentClassName }, react_1.default.Children.map(children, function (input) {
                return input && (react_1.default.createElement(FormInput_1.default, { basePath: basePath, input: input, record: record, resource: resource, variant: variant, margin: margin }));
            })));
        };
        return _this;
    }
    FormTab.prototype.render = function () {
        var _a = this.props, children = _a.children, intent = _a.intent, rest = __rest(_a, ["children", "intent"]);
