...
var RadioButtonGroupInputItem = function (_a) {
    ...
    return (react_1.default.createElement(FormControlLabel_1.default, { label: label, htmlFor: nodeId, control: react_1.default.createElement(Radio_1.default, __assign({ id: nodeId, color: "primary" }, inputProps)) }));
};
