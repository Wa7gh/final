    ...
    undoableEventEmitter_1.default.once('end', function (_a) {
        ...
        dataProvider[type](resource, payload)
            ...
            dispatch({
                ...
                meta: __assign({}, rest, { resource: resource, fetchResponse: getFetchType_1.default(type), fetchStatus: fetchActions_1.FETCH_END }),
            });
            ...
            return logoutIfAccessDenied(error).then(function (loggedOut) {
                ...
                dispatch({
                    ...
                    requestPayload: payload,
                    meta: __assign({}, rest, { resource: resource, fetchResponse: getFetchType_1.default(type), fetchStatus: fetchActions_1.FETCH_ERROR }),
                });
